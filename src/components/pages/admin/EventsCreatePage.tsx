...
interface EventsCreatePageProps {
  currentPage: string;
...
export function EventsCreatePage({ currentPage, onNavigate, onLogout }: EventsCreatePageProps) {
  ...
  async function handleSave(status: 'draft' | 'published') {
    if (!formData.name.trim() || !formData.summary.trim() || !formData.content.trim()) {
    ...
    setSaving(status);
    try {
      const created = await apiClient.post<{ id: string; slug: string }>('events', {
        name: formData.name,
      ...
      onNavigate(`admin/events/edit/${created.id}`);
    } catch (err) {
  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-[#0F0F10]">
      ...
      <div className="flex-1 flex flex-col overflow-hidden md:ml-64">
        <AdminHeader title="Create Event" onMenuClick={() => setIsMobileSidebarOpen(true)} />
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <div className="bg-white dark:bg-[#1A1A1C] rounded-xl p-6 border border-gray-200 dark:border-gray-800">
                  ...
                  <textarea
                    ...
                    placeholder="Full description, agenda, and details..."
                    rows={12}
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white dark:bg-[#1A1A1C] rounded-xl p-6 border border-gray-200 dark:border-gray-800">
                  ...
                  <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                    Manage organizers under Events Management → Organizers.
                  </p>
                </div>
