...
const NAV_ITEMS = [
  ...
  { name: 'Latest', slug: 'latest', page: 'news/latest' },
  {
    ...
    children: [
      ...
      { label: 'Bitcoin', page: 'news/markets' },
      { label: 'Ethereum', page: 'news/markets' },
      { label: 'Altcoins', page: 'news/markets' },
      { label: 'Stablecoins', page: 'news/markets' },
      { label: 'ETF', page: 'news/markets' },
      { label: 'Technical Analysis', page: 'news/markets' },
      { label: 'Investment', page: 'news/markets' },
    ],
  },
  {
    name: 'Ecosystem', slug: 'ecosystem', page: 'news/ecosystem',
    children: [
      { label: 'Blockchain', page: 'news/ecosystem' },
      { label: 'Web3', page: 'news/ecosystem' },
      { label: 'DeFi', page: 'news/ecosystem' },
      { label: 'Exchanges', page: 'news/ecosystem' },
      { label: 'Layer 1', page: 'news/ecosystem' },
      { label: 'Layer 2', page: 'news/ecosystem' },
      { label: 'NFT', page: 'news/ecosystem' },
      { label: 'DAO', page: 'news/ecosystem' },
      { label: 'RWA', page: 'news/ecosystem' },
      { label: 'DePIN', page: 'news/ecosystem' },
      { label: 'Security', page: 'news/ecosystem' },
      { label: 'Infrastructure', page: 'news/ecosystem' },
    ],
  },
  {
    name: 'Regulation', slug: 'regulation', page: 'news/regulation',
    children: [
      { label: 'Global', page: 'news/regulation' },
      { label: 'United States', page: 'news/regulation' },
      { label: 'Europe', page: 'news/regulation' },
      { label: 'Asia-Pacific', page: 'news/regulation' },
      { label: 'Middle East', page: 'news/regulation' },
      { label: 'India', page: 'news/regulation' },
      { label: 'Tax', page: 'news/regulation' },
      { label: 'AML / KYC', page: 'news/regulation' },
      { label: 'Compliance', page: 'news/regulation' },
    ],
  },
  {
    name: 'Research', slug: 'research', page: 'news/research',
    children: [
      { label: 'Industry Reports', page: 'news/research' },
      { label: 'Market Reports', page: 'news/research' },
      { label: 'Deep Dive', page: 'news/research' },
      { label: 'Company Research', page: 'news/research' },
      { label: 'Opinion', page: 'news/research' },
      { label: 'Interviews', page: 'news/research' },
    ],
  },
  {
    name: 'Learn', slug: 'learn', page: 'learn',
    children: [
      { label: 'Blockchain Basics', page: 'learn' },
      { label: 'Bitcoin', page: 'learn' },
      { label: 'Ethereum', page: 'learn' },
      { label: 'Trading', page: 'learn' },
      { label: 'Wallets', page: 'learn' },
      { label: 'Security', page: 'learn' },
      { label: 'Glossary', page: 'learn' },
    ],
  },
];
...
export function Header({ onNavigate, currentPage = 'home' }: HeaderProps) {
  ...
  const isActive = (slug: string) =>
    slug === 'home'
      ? currentPage === 'home'
      : currentPage === slug || currentPage.startsWith(`news/${slug}`) || (slug === 'learn' && currentPage === 'learn');
      ...
      <div className={`fixed inset-0 z-50 lg:hidden transition-all duration-300 ${isMobileMenuOpen ? 'visible' : 'invisible'}`}>
        ...
        <div className={`absolute left-0 top-0 bottom-0 w-[85vw] max-w-[340px] bg-white dark:bg-[#0F0F10] flex flex-col transition-transform duration-300 ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
          ...
          <div className="border-t border-gray-200 dark:border-gray-800 px-5 py-4 space-y-3">
            ...
            {/* RSS */}
            <button
              onClick={() => { onNavigate?.('rss'); setIsMobileMenuOpen(false); }}
